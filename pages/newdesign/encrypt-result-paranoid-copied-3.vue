          ...
          <main>
            <div class="main page__main">
              <div class="main_wrapper">
                <EncryptResultParanoidCopied3></EncryptResultParanoidCopied3>
              </div>
            </div>
          </main>
        </div>
...
<script>
  ...
  import EncryptResultParanoidCopied3 from '~/components/newcomponents/EncryptResultParanoidCopied3.vue'
