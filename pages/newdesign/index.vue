<template>
  <main
    ...
    v-bind:class="{ 'page_pattern_paranoid': $store.state.privateMode, 'page_modal':  $store.state.throwFiles}">

    <ThrowFiles v-if="$store.state.throwFiles"></ThrowFiles>
    <WaitLoader v-if="$store.state.requestInProgress"></WaitLoader>
    <div v-if="!$store.state.requestInProgress" class="page__wrapper"
