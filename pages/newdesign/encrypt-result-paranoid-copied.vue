          ...
          <main>
            <div class="main page__main">
              <div class="main_wrapper">
                <EncryptResultParanoidCopied></EncryptResultParanoidCopied>
              </div>
            </div>
          </main>
        </div>
...
<script>
  ...
  import EncryptResultParanoidCopied from '~/components/newcomponents/EncryptResultParanoidCopied.vue'
